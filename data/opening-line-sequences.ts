...
export const MAIN_LINE_STEP_HINTS: Partial<Record<string, string[]>> = {
  italian: [
    ...
    "Nbd2 reroutes the queen’s knight toward f1 or e4 ideas without blocking the Italian bishop.",
    "...a6 is a useful waiting move that can support ...b5 or keep the queenside flexible.",
    "Bb3 is a classic Italian retreat that eyes f7 while freeing the a2–g2 diagonal.",
    "...Rc8 connects the rook to an open file and signals queenside counterplay is coming.",
  ],
  london: [
...
export const DEVIATION_LINE_MOVES: Partial<Record<string, DeviationBranch[]>> = {
  italian: [
    ...
    {
      title: "Vs 4...Be7 (Pianissimo shell)",
      moves: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "c3", "Be7", "d4", "exd4", "cxd4", "d6", "O-O", "Nf6"],
      plan: "Keep the center fluid: finish development (Re1, h3 if useful), then choose between d5 thrusts or kingside buildup once Black commits the king.",
    },
  ],
  london: [
    {
